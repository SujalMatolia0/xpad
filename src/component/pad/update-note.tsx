...
export const UpdateNote = () => {
  ...
  if (GetNoteApi.isLoading) return <Loader />;

  if (GetNoteApi.error) {
    return <div>Error: {GetNoteApi.error.message}</div>;
  }

  return (
    <Stack gap="xl">
      <form
        onSubmit={UpdateNoteForm.onSubmit((data) =>
          UpdateNoteApi.mutate({ id: NoteId, ...data })
        )}
      >
        <TextInput
          label="Title"
